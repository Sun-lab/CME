...
cDat6 = rbind(cDat,  pt1)

dim(cDat6)
cDat6[(nrow(cDat6)-5):nrow(cDat6),1:5]
cDat6$id

write.table(cDat6, file = "cov_EM_with_ECM_purity6.txt",
...
covariates_file_name = "cov_EM_with_ECM_purity6.txt"
expression_file_name = "expression_log_TReC_rm_cn.txt"
output_file_name     = "expression_vs_methylation_ECM_purity6.txt"
